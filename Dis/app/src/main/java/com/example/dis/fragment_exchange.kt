 ...
 * Use the [fragment_exchange.newInstance] factory method to
 * create an instance of this fragment.
 */
class fragment_exchange : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.button.setOnClickListener {
            fragmentManager?.beginTransaction()?.apply {
                replace(R.id.fragments,items_main(),items_main::class.java.simpleName)
